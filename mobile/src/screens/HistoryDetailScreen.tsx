...
const styles = StyleSheet.create({
  ...
  goalText: { color: Colors.textPrimary, fontSize: 15, fontWeight: "600", lineHeight: 22, marginBottom: 6 },
  dateText: { color: Colors.textMuted, fontSize: 11, marginBottom: 16 },
  ...
  resultTitle: { color: Colors.green, fontSize: 14, fontWeight: "700" },
  copyBtn: { flexDirection: "row", alignItems: "center", gap: 4 },
  copyLabel: { color: Colors.cyan, fontSize: 12 },
  ...
  sectionLabel: { color: Colors.textSecondary, fontSize: 11, fontWeight: "700", letterSpacing: 1, textTransform: "uppercase", marginBottom: 10, marginTop: 4 },
