...
const styles = StyleSheet.create({
  ...
  dateText: { flex: 1, color: Colors.textMuted, fontSize: 11, fontWeight: "500" },
  goalText: { color: Colors.textPrimary, fontSize: 14, fontWeight: "600", lineHeight: 20, marginBottom: 12 },
  ...
  resultText: { color: "#065F46", fontSize: 12, lineHeight: 18, fontWeight: "500" },
